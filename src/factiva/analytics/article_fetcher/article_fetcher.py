...
class UIArticle():
    ...
    # TODO: Improve parsing based on the an WSJO000020250109el19002bd (Links and images)
    @property
    def txt(self) -> str:
        disp_txt = f"\n{self.headline}"
...
class ArticleFetcher():
    """
    Allows to fetch articles against the Article API Service using
    ...
    .. code-block::
        ...
        <class 'factiva.analytics.article_fetcher.article_fetcher.ArticleFetcher'>
    ...
    """
    __API_ARTICLE_ENDPOINT_BASEURL = f"{const.API_HOST}{const.API_ARTICLE_ENDPOINT_BASEURL}/"
    ...
    #       be possible to implement a 'cache' to avoid excess of fetches when refreshing a
    #       page.
    # TODO: When UIArticle is implemente, this will become a list of UIArticle
    # fetched_articles = {}
    # """
    # List that stores last fetched articles.
    # """
    ...
    def fetch_single_article(self, an:str) -> UIArticle:
        """
        ...
        Examples
        --------
        Creating a new ``Articlefetcher`` instance which reads credential values from
        environment variables and returns a single article object ``UIArticle``:

        .. code-block:: python

            from factiva.analytics import ArticleFetcher
            ar = ArticleFetcher()
            article = ar.fetch_single_article(an='WSJO000020221229eict000jh')
            print(article.txt)
        ...
        .. code-block::
            ...
            <class 'factiva.analytics.article_fetcher.article_fetcher.UIArticle'>
        ...
        # if an in self.fetched_articles.keys():
        #     return self.fetched_articles[an]
        ...
        article_response = req.api_send_request(
            method="GET",
            endpoint_url=f"{self.__API_ARTICLE_ENDPOINT_BASEURL}{drn_ref}",
            headers=req_headers
        )
        ...
        # self.fetched_articles = [article_obj]
        return article_obj


    # TODO: Implement a metod to fetch multiple articles based on a param containing a list of ANs
